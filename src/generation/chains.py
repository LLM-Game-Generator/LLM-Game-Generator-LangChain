...
class TokenTrackerCallback(BaseCallbackHandler):
    def __init__(self):
        ...
        self.max_token_one_time_usage = 0
    ...
    def one_time_max_token_usage(self):
        return self.max_token_one_time_usage
            ...
            for gen_list in response.generations:
                for gen in gen_list:
                    if hasattr(gen, "message") and hasattr(gen.message,
                        ...
                        if self.max_token_one_time_usage < (prompt_tokens + completion_tokens):
                            self.max_token_one_time_usage = prompt_tokens + completion_tokens
